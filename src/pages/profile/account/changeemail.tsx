...
export default function ChangeEmail() {
    ...
    useEffect(() => {
        setNotif(
            'Upon changing your email address you will recieve an email at your new email address with a verification code to confirm your new email address.'
        )
    }, [])
    ...
    return (
        <div className="max-w-sm w-full mx-auto p-5">
            ...
            {stage === 0 && (
                <ChangeEmailForm
                    {...{ onBack: () => router.push('/profile/account'), existingEmails, handleChangeEmail }}
                />
            )}
